...
<div id="contenu_int">
	<p><a href="accueil.php" class="lien04"><?php echo trad('Accueil', 'admin'); ?> </a><img src="gfx/suivant.gif" width="12" height="9" border="0" /><a href="commande.php" class="lien04"><?php echo trad('Gestion_commandes', 'admin'); ?></a>
    </p>
...
<ul class="ligne_claire_BlocDescription" style="background-image: url(gfx/degrade_ligne1.png); background-repeat: repeat-x;">
		<li class="designation" style="width:280px; background-image: url(gfx/degrade_ligne1.png); background-repeat: repeat-x;"><?php echo trad('Choix_client', 'admin'); ?> <span class="note"><?php echo trad('commencer', 'admin'); ?></span></li>
		<li>
		<div id="nclient">
	...
	<ul class="ligne_fonce_BlocDescription">
		...
		<li>
				 <a href="#TB_inline?height=400&amp;width=800&amp;inlineId=contenu_cli&amp;modal=true" class="thickbox"><?php echo trad('creer_client', 'admin'); ?></a>
				</li>
	</ul>
