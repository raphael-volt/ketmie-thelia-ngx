...
export class TemplateDirective implements OnChanges {
  ...
  @Input() kTheme: 'light' | 'dark' = 'light';

  @Input() kSliderDir: 'left' | 'right' | 'top' | 'bottom' = 'left';

  @Input() kSlider: boolean = false;

  @Input() kSlideIn: boolean = false;

  @Input() kSlideOut: boolean = false;
