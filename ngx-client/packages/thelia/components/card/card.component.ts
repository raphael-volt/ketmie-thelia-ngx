...
import { CardService, DeclinationService } from "@thelia/api";
import { SliderBaseComponent } from "@thelia/common";
import { serializableCardItem, Card, CardItem, IDeclination, IDeclinationItem } from "@thelia/model";

export type CellType = string & "image" | "quantity" | "options" | "product" | "price" | "action" | "none"
type TypeMap<K extends string, T> = {
  [P in K]?: T;
}
