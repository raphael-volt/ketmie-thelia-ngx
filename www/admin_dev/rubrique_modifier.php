...
/*************************************************************************************/
    ...
    function ajouter($parent, $lang, $titre, $chapo, $description, $postscriptum, $lien, $ligne){
        ...
        {
	        $query = "SELECT caracteristique as carac FROM $rubcaracteristique->table WHERE rubrique={$parent}";
	        $result = $rubcaracteristique->query_liste($query);
	        foreach ($result as $row) 
	        {
	        	$rubcaracteristique->rubrique = $lastid;
	        	$rubcaracteristique->caracteristique = $row->carac;
	            $rubcaracteristique->add();
	        }
        }	
