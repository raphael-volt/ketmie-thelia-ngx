...
class Rubriquedesc extends BaseobjdescReecriture {
	...
	public $bddvars = array("id", "rubrique", "lang", "titre", "chapo", "description", "postscriptum");

	public function __construct($rubrique = 0, $lang = false){
		parent::__construct('rubrique', $rubrique, $lang);
	}

	public function charger($rubrique, $lang = false){
		return $this->charger_desc($rubrique, $lang);
	}
