...
import { ApiService, LayoutService, getMaxScreenWidth } from "@thelia/api";
import { SliderBaseComponent,  ImgTileService } from "@thelia/common";
import { LoaderEvent } from "@thelia/events";
import { Subscription, Observable, Observer } from "rxjs";
import { SubscriptionCollector } from "@thelia/utils";
@Component({
  selector: 'category',
