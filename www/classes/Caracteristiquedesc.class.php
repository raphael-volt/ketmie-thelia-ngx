...
class Caracteristiquedesc extends Baseobjdesc {
	...
	public $bddvars = array("id", "caracteristique", "lang", "titre", "chapo", "description");

	public function __construct($caracteristique = 0, $lang = false) {
		parent::__construct('caracteristique', $caracteristique, $lang);
	}

	public function charger($caracteristique, $lang = false) {
		return parent::charger_desc($caracteristique, $lang);
	}
}
?>