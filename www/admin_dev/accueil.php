	...
	<div id="subwrapper">
		...
		<div id="contenu_int">
			...
			<div id="bloc_informations">
				...
				<ul>
					<li class="entete" ><?php echo trad('INFOS_THELIA', 'admin'); ?></li>
					...
					<?php if($versiondispo != "") {?>
					<li class="fonce" style="width:222px; background-color:#9eb0be;border-bottom: 1px dotted #FFF;"><?php echo trad('Derniere_version_disponible', 'admin'); ?></li>
					<li class="fonce" style="width:72px;"><a href="http://sourceforge.net/projects/thelia/files/latest/download?source=files">V<?php echo $versiondispo; ?></a></li>
					<?php } ?>
					<li class="lignebottom" style="width:222px; background-color:#9eb0be;"><?php echo trad('Actualites', 'admin'); ?></li>
					<li class="lignebottom" style="width:72px;"><a href="http://blog.thelia.net" target="_blank"><?php echo trad('cliquer_ici', 'admin'); ?></a></li>
				</ul>
			</div>
		</div>
