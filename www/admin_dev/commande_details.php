...
<?php
	...
	// Filtretarifbo::addLog("commande_details.php?action=$action&statutch=$statutch");
?>
...
<div id="contenu_int">
		<p><a href="accueil.php" class="lien04"><?php echo trad('Accueil', 'admin', 'admin'); ?> </a><img src="gfx/suivant.gif" width="12" height="9" border="0" /><a href="commande.php" class="lien04"><?php echo trad('Gestion_commandes', 'admin'); ?></a></p>
	...
	function liste_parent($parent, $niveau, $commande, $grandParent, $debutLie=0)
	{
		...
		while($resul && $row = $venteprod->fetch_object($resul)) {
			...
			?>
				...
				<li style="width:<?php echo $largeurDesignation; ?>px; padding-left:<?php echo $paddingIndentation; ?>px;"><?php echo $indentation . " " . $venteprod->ref . " - " . $titrerub; ?> - <?php echo(str_replace("\n", "<br />", $venteprod->titre)); ?></li>
...
<ul class="Nav_bloc_description">
		<li style="width:60px;"><?php echo trad('Num_Fact', 'admin'); ?></li>
		<li style="width:240px; border-left:1px solid #96A8B5;"><?php echo trad('Societe', 'admin'); ?></li>
		<li style="width:150px; border-left:1px solid #96A8B5;"><?php echo trad('Nom', 'admin'); ?> &amp; <?php echo trad('Prenom', 'admin'); ?></li>
		<li style="border-left:1px solid #96A8B5;"><?php echo trad('Date_Heure', 'admin'); ?></li>
</ul>
...
<div class="entete_liste_client">
	...
	<ul class="ligne_claire_BlocDescription">
		...
		if($promoutil->charger_commande($commande->id)){
			...
			{
			?>
			<?php echo $promoutil->code; ?> (<?php echo $promoutil->valeur; echo($promoutil->type==Promo::TYPE_SOMME)?'€':'%'; ?>)
			<?php
			}
		}
		?></li>
...
<ul class="ligne_claire_BlocDescription" style="background-image: url(gfx/degrade_ligne1.png); background-repeat: repeat-x;">
	<li class="designation" style="width:290px; background-image: url(gfx/degrade_ligne1.png); background-repeat: repeat-x;"><?php echo trad('Societe', 'admin'); ?></li>
