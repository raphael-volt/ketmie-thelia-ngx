...
else if ($_SESSION["navig"]->urlpageret == "")
    $_SESSION["navig"]->urlpageret = urlfond();

$_SESSION["navig"]->urlpageret = supprimer_panier($_SESSION["navig"]->urlpageret);
// Sécurisation
