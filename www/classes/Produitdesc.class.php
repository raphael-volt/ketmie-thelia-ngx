...
class Produitdesc extends BaseobjdescReecriture {
	...
	public $bddvars = array("id", "produit", "titre", "chapo", "description", "lang", "postscriptum");

	public function __construct($produit = 0, $lang = false){
		parent::__construct('produit', $produit, $lang);
	}

	public function charger($produit, $lang = false){
		return $this->charger_desc($produit, $lang);
	}
